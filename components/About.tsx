      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-brand-secondary">
              <img 
                ...
                alt="FB Towing Truck Front View" 
          ...
          <div className="w-full lg:w-1/2">
               <h4 className="text-brand-accent font-bold uppercase tracking-widest mb-3 text-sm">About FB Towing</h4>
            ...
            <p className="text-slate-400 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
                 Based in <strong className="text-white">South East Melbourne</strong>, FB Towing is a premier, owner-operated towing company serving Hampton Park and the greater South East Melbourne area.
            </p>
